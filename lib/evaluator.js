...
class ImageEvaluator {
     ...
     */
    async compareImages(targetImagePath, generatedImagePath) {
        try {
                    ...
                    messages: [
                        {
                            ...
                            content: [
                                {
                                    type: 'text',
                                    text: `Please compare these two images and provide:
1. A detailed description of the differences between them
2. No ambigious or artistic critical language. Only visual detail on the differences.
3. A similarity score from 0-10 (where 10 is identical)
4. Specific suggestions for how to modify the second image to better match the first

First image is the target, second image is the generated attempt.`
                                },
                                {
                                    type: 'image_url',
                                    image_url: {
