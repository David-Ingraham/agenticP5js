                    ...
                    messages: [
                        {
                            ...
                            content: [
                                {
                                    type: 'text',
                                    text: `Compare these images and provide:

1. A similarity score from 0-10 (where 10 is identical)

2. Exactly 3 specific, actionable improvements for the second image:
   - Use simple language: 'add X', 'remove Y', 'change Z to W'
   - Focus on the most important differences only
   - One sentence per improvement
   - Example: 'Add thin black border around entire canvas'

3. No detailed descriptions or explanations - just the score and 3 clear actions.`
                                },
                                {
                                    type: 'image_url',
                                    image_url: {
