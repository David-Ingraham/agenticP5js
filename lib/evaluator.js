...
2. List each difference between the two images:
   ...
   -Talk to the model in the second person, for example, your attmept missed this thing that the target image has
   -Be consice but still detailed
   -DO NOT MENTION SIMILARITIES, ONLY DIFFERENCES
   -You are being tasked to evalute another llm's ability to generate an image that is as similar to the target image as possible`
                                },
                                {
                                    type: 'image_url',
                                    image_url: {
